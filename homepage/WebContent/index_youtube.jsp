    ...
    <div class="w3-container w3-content w3-padding-64" style="max-width:800px">
      ...
      <div class="w3-row-padding w3-padding-32" style="margin:0 -16px">
        <div class="w3-third w3-margin-bottom">
          <iframe style="width:245px; height:138px" class="w3-hover-opacity" 
					src="https://www.youtube.com/embed/qFrxdkSP7mk">
					<!-- watch?v= 를 embed로 바꿔야한다. -->
			</iframe>
        ...
        <div class="w3-third w3-margin-bottom">
        	<iframe style="width:245px; height:138px" class="w3-hover-opacity" 
					src="https://www.youtube.com/embed/-O_PcCj0t_I">
        ...
        <div class="w3-third w3-margin-bottom">
          <iframe style="width:245px; height:138px" class="w3-hover-opacity" 
					src="https://www.youtube.com/embed/Zd22wv-rIi4">
					<!-- watch?v= 를 embed로 바꿔야한다. -->
			</iframe>
          <div class="w3-container w3-white">
            <p><b>Namisum</b></p>
